...
public class TmTickets  implements java.io.Serializable {
     ...
     private String tid;
     private Set<TmTicketReply> tmTicketReplies = new HashSet<TmTicketReply>(0);
     private Set<TmTicketMedia> tmTicketMedias = new HashSet<TmTicketMedia>(0);
    ...
    public Set<TmTicketReply> getTmTicketReplies() {
        return this.tmTicketReplies;
    }
    
    public void setTmTicketReplies(Set<TmTicketReply> tmTicketReplies) {
        this.tmTicketReplies = tmTicketReplies;
    }
    public Set<TmTicketMedia> getTmTicketMedias() {
        return this.tmTicketMedias;
    }
    
    public void setTmTicketMedias(Set<TmTicketMedia> tmTicketMedias) {
        this.tmTicketMedias = tmTicketMedias;
    }
