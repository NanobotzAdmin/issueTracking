...
import com.it.db.UmUserHasInterfaceComponentId;
    ...
    public synchronized List<Object[]> searchusersHasComponenntsByUserIdAndInterfaceTopicId(Session ses, int topicId,int userId) {
      ...
      public synchronized UmUserHasInterfaceComponent removeUserHasComponent(Session ses, int userId, int componentId) {
        try {
            ...
            UmUserHasInterfaceComponentId addComponentIdAndUserId =  new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Component_Id().addUserHasInterfaceComponentToComposite(ses, userId, componentId);
            ...
            if (addComponentIdAndUserId != null) {
                ...
                UmUserHasInterfaceComponent searchComponentDetail = new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().getAllUserHasInterfaceComponentByUserIdAndComponentIdUniq(ses, selectedUser.getId(), selectedComponent.getId());    
...
//    method for add interface component to user
    public synchronized UmUserHasInterfaceComponent addUserHasInterfaceComponent(Session ses, int userId, int component, Date createDate, Date updateDate,byte status, UmUser createdBy, UmUser updatedBy) {
        ...
        try {
            ...
            UmUserHasInterfaceComponentId addComponentIdAndUserId = new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Component_Id().addUserHasInterfaceComponentToComposite(ses, userId, component);
