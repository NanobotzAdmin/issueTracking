 ...
 * @author JOY
 */
@WebServlet(name = "ticketManagement_removeUserFromTicket", urlPatterns = {"/ticketManagement_removeUserFromTicket"})
public class ticketManagement_removeUserFromTicket extends HttpServlet {
...
//                            delete user
                            ...
                            String removeUserFromTicketSessionActivityContent = selectedUser.getFirstName() + " User has been Removed From " + selectedTicket.getTicketName() + " Issue by " + activeUser.getFirstName() + " on " + addedDate;
                            SmSessionActivity sessionActivityToRemoveUserFromTicket = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, removeUserFromTicketSessionActivityContent, new Date(), STATIC_DATA_MODEL.DELETE, STATIC_DATA_MODEL.ISSUESMANAGEMENT, selectedTicket.getId(), activeSession, activeUser);
                            tr.commit();
