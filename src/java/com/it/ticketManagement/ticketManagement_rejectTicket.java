...
//                        select Tickets 
                    ...
                    if (selectedTicket != null) {
                        ...
                        String TicketCompletedSessionActivityContent = selectedTicket.getTicketName() + " Issue has been Rejected by " + activeUser.getFirstName() + " on " + updatedDate;
                        ...
                        if (!getTicketHasUsers.isEmpty()) {
                            for (TmTicketsHasUmUser ticketHasUser : getTicketHasUsers) {
                                if (ticketHasUser.getUmUser().getMobileNumber() != null) {
                                    String smsCnt = activeUser.getFirstName() + " " + activeUser.getLastName() + " has Reject Issue Number " + selectedTicket.getTid();
                        ...
                        resultMap.put("displayMessage", "Issue Rejected");
                    } else {
