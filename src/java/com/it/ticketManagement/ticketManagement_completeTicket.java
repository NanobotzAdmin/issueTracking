...
//                        Date date1 = new Date(selectedTicket.getCreatedAt());
                        String issuesStartDate = selectedTicket.getCreatedAt().toString();
                        String todaty = sdf.format(new Date());
                        Date d1 = sdf.parse(issuesStartDate);
                        ...
                        String TicketCompletedSessionActivityContent = selectedTicket.getTicketName() + " Issue has been Completed by " + activeUser.getFirstName() + " on " + updatedDate;
                        ...
                        String smsCnt = activeUser.getFirstName() + " " + activeUser.getLastName() + " has Completed Issue Number " + selectedTicket.getTid();
                        String smsStatus = SMS_MODEL.Send_SMS(ticketCreatedUser.getMobileNumber(), smsCnt);
                        tr.commit();
                        resultMap.put("result", "1");
                        resultMap.put("displayMessage", "Issue Completed");
                    } else {
