 ...
 * @author JOY
 */
@WebServlet(name = "userManagement_sendMail", urlPatterns = {"/userManagement_sendMail"})
public class userManagement_sendMail extends HttpServlet {
...
//                        selected user
                    UmUser selectedUser = (UmUser) ses.load(UmUser.class, id);
                    if (selectedUser == null) {
                        resultMap.put("result", "0");
                        resultMap.put("displayMessage", "User Not Found");
                    } else {

                        String mailContent = "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" style=\"font-family:arial, 'helvetica neue', helvetica, sans-serif\"> \n"
                                + "    <head> \n"
                                + "        <meta charset=\"UTF-8\"> \n"
                                ...
                                + "                                                                                                    Username: <b>" + selectedUser.getUserName() + "</b><br> \n"
                                + "                                                                                                    Password: <b>" + selectedUser.getPassword()+ "</b><br>\n"
                                + "                                                                                                    <br></br>\n"
                        ...
                        if (selectedUser.getEmailAddress() != null) {
                            EMAIL_MODEL.Sendmail(selectedUser.getEmailAddress(), "Initial Login Authentication", mailContent);
                            resultMap.put("result", "1");
                            resultMap.put("displayMessage", "Saved Success...");
                        } else {
                            resultMap.put("result", "");
                            resultMap.put("displayMessage", "User Email Is Empty");
                        }
