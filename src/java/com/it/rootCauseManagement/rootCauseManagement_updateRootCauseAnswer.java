...
//                                check updated answer name exists
                                RcasAnswers checkNameExists = new com.it.rootCauseManagementModel.RCMS_Rcas_Answers().checkNameExists(ses, answerU);
...
//                            update Answer details
                                    RcasAnswers updateAnswer = new com.it.rootCauseManagementModel.RCMS_Rcas_Answers().updateRootCauseAnswer(ses, answerU, STATIC_DATA_MODEL.PMACTIVE, updatedDate, selectedRCA, activeUser.getId());
                                    if (updateAnswer != null) {
                                        ...
                                        SmSessionActivity sessionActivityToUpdateAnswer = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, updateAnswerSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.ROOTCAUSEANSWER,updateAnswer.getId(),activeSession, activeUser);
