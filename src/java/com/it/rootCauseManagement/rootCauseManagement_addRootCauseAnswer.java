...
//                            save Root Cause Answer details
                            RcasAnswers addNewRootCauseAnswer = new com.it.rootCauseManagementModel.RCMS_Rcas_Answers().saveRootCauseAnswer(ses, answer, STATIC_DATA_MODEL.PMACTIVE, updatedDate, updatedDate, activeUser.getId(), activeUser.getId());
                            if (addNewRootCauseAnswer != null) {
                                ...
                                SmSessionActivity sessionActivityToAddRCA = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, saveRCASessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.ROOTCAUSEANSWER,addNewRootCauseAnswer.getId(),activeSession, activeUser);
