...
//                                check updated location name exists
                                LmLocations checkNameExists = new com.it.locationManagementModel.LMS_LM_Locations().checkNameExists(ses, locationName);
...
//                            update location details
                                    LmLocations updateLocation = new com.it.locationManagementModel.LMS_LM_Locations().updateLocation(ses, locationName, address, mobile, landnumber, STATIC_DATA_MODEL.ISACTIVE, updatedDate, selectedBranchManager, selectedLocation, activeUser.getId());
...
//                                                            check user elready Exists
                                                        LmLocationsHasUmUser checkUser = new com.it.locationManagementModel.LMS_LM_Locations_Has_Um_User().getUsersByLocationId(ses, selectedLocation.getId(), selecUser.getId());
                                                        if (checkUser == null) {
//                                                    add user to location
                                                            LmLocationsHasUmUser addUsersToLocation = new com.it.locationManagementModel.LMS_LM_Locations_Has_Um_User().addLocationHasUsers(ses, selectedLocation.getId(), selecUser.getId(), STATIC_DATA_MODEL.ISACTIVE, updatedDate, updatedDate, activeUser.getId(), activeUser.getId());
                                                        }
                                                    }
                                                }
                                            }
