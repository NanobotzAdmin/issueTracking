            ...
            if (request.getSession().getAttribute("nowLoginUser") == null) {
                ...
                if (activeUser == null) {
                    ...
                    //Search already exist interface
                        PmInterface checkInterface = new com.it.privilegeManagementModel.PMS_PM_Interface().searchInterfaceNameExit(ses, interfaceName);
                        ...
                        //Save interface
                        PmInterface interfaces = new com.it.privilegeManagementModel.PMS_PM_Interface().saveInterface(ses, interfaceName, interfaceURL, iconClass, titleClass, addedDate, addedDate, STATIC_DATA_MODEL.PMACTIVE, interfaceTopic, activeUser, activeUser);
                        if (interfaces != null) {
                            //Get Active session object
                                ...
                                SmSessionActivity sessionActivityToAddInterface = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveInterfaceSessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.INTERFACESAVE, activeSession, activeUser);
