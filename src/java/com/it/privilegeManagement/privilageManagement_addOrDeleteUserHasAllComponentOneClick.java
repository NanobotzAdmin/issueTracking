...
//                                        check user has interface component
                                        UmUserHasInterfaceComponent checkUserHasComponent = new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().getAllUserHasInterfaceComponentByUserIdAndComponentIdUniq(session, selectedUser.getId(), Interfacecomponents.getId());
//                                        System.out.println("check = " + checkUserHasComponent.getUmUserMi7ByUmUserMi7Id().getFullName() + " " + checkUserHasComponent.getUmInterfacecomponentsMi7().getComponentName());
                                        if (checkUserHasComponent == null) {
                                            UmUserHasInterfaceComponent addComponentToUser = new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().addUserHasInterfaceComponent(session, selectedUser.getId(), Interfacecomponents.getId(), addedDate, updatedDate, STATIC_DATA_MODEL.PMACTIVE, activeUser, activeUser);
...
//                                            add user has interface component
                                            xx++;
                                            UmUserHasInterfaceTopic addUserHasInterfaceHas = new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Topic().saveInterfacetopicHasUser(session, selectedUser.getId(), selectedTopic.getId(), STATIC_DATA_MODEL.PMACTIVE, xx, addedDate, updatedDate, activeUser, activeUser);
...
//                                         save interface topic top user session activity
                            ...
                            if (status.equals("S")) {
                                ...
                                if (!getComponentByTopic.isEmpty()) {
                                    for (PmInterfaceComponent Interfacecomponents : getComponentByTopic) {
                                        int deleteComponent = new com.it.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().deleteUserHasInterfaceComponentByUserId(session, selectedUser.getId(), Interfacecomponents.getId());
