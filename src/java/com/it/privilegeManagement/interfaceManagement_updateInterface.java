                ...
                if (activeUser == null) {
                    ...
                    if (interfaceTopicId == 0) {
                        ...
                        if (selectedInterface == null) {
                            ...
                            //Update interface
                            PmInterface updateInterfaces = new com.it.privilegeManagementModel.PMS_PM_Interface().updateInterface(ses, interfaceName, interfacePath, iconClass, titleClass, updatedDate, STATIC_DATA_MODEL.PMACTIVE, interfaceTopic, activeUser, selectedInterface);
...
//Get Active session object
                                ...
                                SmSessionActivity sessionActivityToUpdateInterface = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, updateInterfaceSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.INTERFACEUPDATE, activeSession, activeUser);
