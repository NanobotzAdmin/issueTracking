            ...
            if (request.getSession().getAttribute("nowLoginUser") == null) {
                ...
                if (activeUser == null) {
                    ...
                    if (interfaceTopicName.isEmpty()) {
                        ...
                        PmInterfaceTopic checkTopic = new com.it.privilegeManagementModel.PMS_PM_Interface_Topic().searchInterfaceGroupNameExit(ses, interfaceTopicName);
                        if (checkTopic != null) {
                            resultMap.put("result", "0");
                            resultMap.put("displayMessage", "Interface topic already exist.");
                        } else {
                            //Save interface topic
                            PmInterfaceTopic interfaceTopic = new com.it.privilegeManagementModel.PMS_PM_Interface_Topic().saveInterfaceGroup(ses, interfaceTopicName, interfaceTopicIcon, section, updatedDate, updatedDate, STATIC_DATA_MODEL.PMACTIVE, activeUser, activeUser);
                            if (interfaceTopic != null) {
                                ...
                                SmSessionActivity sessionActivityToAddInterfaceTopic = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveInterfaceTopicSessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.INTERFACETOPICSAVE, activeSession, activeUser);
