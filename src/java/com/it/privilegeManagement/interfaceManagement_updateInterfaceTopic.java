...
public class interfaceManagement_updateInterfaceTopic extends HttpServlet {
            ...
            if (request.getSession().getAttribute("nowLoginUser") == null) {
                ...
                if (activeUser == null) {
                    ...
                    if (selectedTopic == null) {
                        ...
                        PmInterfaceTopic updateInterfaceTopic = new com.it.privilegeManagementModel.PMS_PM_Interface_Topic().updateInterfaceGroup(ses, interfaceTopicName, interfaceTopicIcon, topicSection, addedDate, STATIC_DATA_MODEL.PMACTIVE, activeUser, selectedTopic);
 ...
 //Get Active session object
                                ...
                                SmSessionActivity sessionActivityToUpdateInterfaceTopic = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, updateInterfaceTopicSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.INTERFACETOPICUPDATE, activeSession, activeUser);
