...
//                            delete user
                            ...
                            SmSessionActivity sessionActivityToRemoveUserFromQueue = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, removeUserFromQueueSessionActivityContent, new Date(), STATIC_DATA_MODEL.DELETE, STATIC_DATA_MODEL.QUEUEMANAGEMENT, selectedQueue.getId(), activeSession, activeUser);
                            tr.commit();
