...
//                                    delete queue
                            ...
                            SmSessionActivity sessionActivityTodeleteQueue = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, deleteQueueStatusSessionActivityContent, new Date(), STATIC_DATA_MODEL.DELETE, STATIC_DATA_MODEL.QUEUEMANAGEMENT, selectedQueue.getId(), activeSession, activeUser);
