...
//                            save sub Catagory details
                            QmSubCategories addNewSubCategory = new com.it.queueManagementModel.QMS_QM_Sub_Categories().saveSubCategory(ses, subCategoryName, subCategoryDescription, STATIC_DATA_MODEL.PMACTIVE, updatedDate, updatedDate, selectedCategory,activeUser.getId(), activeUser.getId());
                            if (addNewSubCategory != null) {
                                ...
                                SmSessionActivity sessionActivityToAddSubCategory = new com.it.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveSubCategorySessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.SUBCATEGORYSAVE, activeSession, activeUser);
...
//                                                    add user to sub Category
                                                    QmSubCategoriesHasUser addUsersToSubCategory = new com.it.queueManagementModel.QMS_QM_Sub_Categories_Has_User().addSubCategoryHasUsers(ses, addNewSubCategory.getId(), selecUser.getId(), STATIC_DATA_MODEL.PMACTIVE, updatedDate, updatedDate, activeUser.getId(), activeUser.getId());
                                                }
                                            }
                                        }
                                        tr.commit();
