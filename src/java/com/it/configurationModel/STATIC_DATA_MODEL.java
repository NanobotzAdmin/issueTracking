...
//    (activity topics)
    ...
    public static String DESIGNATIONSUPDATE = "Designation Update";
     ...
     public static String ISSUESMANAGEMENT= "Issues Management";
     public static String ISSUESREPLYMANAGEMENT= "Issues Reply Management";
...
//    Ticket  Status 
    ...
    public static Byte TICKETSTARTED= 3;
    public static Byte TICKETCOMPLETED= 4;
    public static Byte TICKETCONFIRMED= 5;
