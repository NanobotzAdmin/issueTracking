...
//                    Save SessionActivity in db
                    SmSessionActivity saveHttpSessionActivity = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveContent, outDate, STATIC_DATA_MODEL.LOGOUT, STATIC_DATA_MODEL.USERLOGOUT, updateHttpSession, activeUser);
