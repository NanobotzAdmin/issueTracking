 ...
 * @author JOY
 */
@WebServlet(name = "userManagement_sendMailsToAllUsers", urlPatterns = {"/userManagement_sendMailsToAllUsers"})
public class userManagement_sendMailsToAllUsers extends HttpServlet {
            ...
            if (request.getSession().getAttribute("nowLoginUser") == null) {
                ...
                if (activeUser == null) {
                    ...
                    Date addedDate = new Date();
                        ...
                        String mailContent = "";
                        List<UmUser> getallUsers = new com.ring.userManagementModel.UMS_UM_User().getAllUsersByStatus(ses, STATIC_DATA_MODEL.PMALL);
                        if (!getallUsers.isEmpty()) {
                            for (UmUser allUser : getallUsers) {
                                ...
                                if (allUser.getEmailAddress() != null) {
                                    ...
                                    EMAIL_MODEL.Sendmail(allUser.getEmailAddress(), "Initial Login Authentication", mailContent);
                                    resultMap.put("result", "1");
                                    resultMap.put("displayMessage", "Email Send...");
