...
//            boolean remember = Boolean.parseBoolean(request.getParameter("remember"));
            if (userName.isEmpty()) {
                ...
                UmUser userLogin = new com.ring.userManagementModel.UMS_UM_User().getUserNameHasUser(ses, userName);
...
//                                    String genAuthKey = new com.ring.configurationModel.KEY_GENERATOR().genAuthenticationKey();
...
//                              save login user session in db  
                                    SmSession saveLoginUserSession = new com.ring.userManagementModel.UMS_UM_Session().saveHttpSession(ses, httpSessionDate, httpSessionDate, httpSessionDate, httpSessipnIpAddress, userLogin);
...
//                                    save session activity
                                    SmSessionActivity saveSessionActivity = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, sessionDescription, httpSessionDate, STATIC_DATA_MODEL.LOGIN, STATIC_DATA_MODEL.USERLOGIN, saveLoginUserSession, userLogin);
