...
//                        selected user role
                            ...
                            int xx = 0;
                            if (status.equals("N")) {
                                UmUserHasInterfaceComponent addComponentToUser = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().addUserHasInterfaceComponent(session, selectedUser.getId(), selectedComponent.getId(), addedDate, updatedDate, STATIC_DATA_MODEL.PMACTIVE, activeUser, activeUser);
...
//                                            add user has interface component
                                        xx++;
                                        UmUserHasInterfaceTopic addUserHasInterfaceTopic = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Topic().saveInterfacetopicHasUser(session, selectedUser.getId(), selectedTopic.getId(), STATIC_DATA_MODEL.PMACTIVE, xx, addedDate, updatedDate, activeUser, activeUser);
                            ...
                            if (status.equals("S")) {
                                int deleteComponent = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().deleteUserHasInterfaceComponentByUserId(session, selectedUser.getId(), selectedComponent.getId());
