...
//                                delete user role has assigned component
                        int deleteComponent = new com.ring.privilegeManagementModel.PMS_PM_User_Role_Has_Interface_Component().deleteUserRoleHasInterface(session, selectedUserRole.getId(), selectedInterface.getId());
...
//                                      delete user role has interface component save session activity?
                            ...
                            SmSessionActivity sessionActivityToDeleteUserRoleHasInterface = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(session, deleteUserRoleHasInterfaceContent, new Date(), STATIC_DATA_MODEL.DELETE, STATIC_DATA_MODEL.USERROLEHASICOMPONENTREMOVE, activeSession, activeUser);
