                ...
                if (activeUser == null) {
                    ...
                    if (interfaceId == 0) {
                        ...
                        if (selectedInterfaceComponent == null) {
                            ...
                            PmInterfaceComponent updateInterfacesComponent = new com.ring.privilegeManagementModel.PMS_PM_Interface_Component().updateInterfaceComponent(ses, interfaceComponentName, interfaceComponentID, addedDate, STATIC_DATA_MODEL.PMACTIVE, interfaceToComponentUP, activeUser, selectedInterfaceComponent);
...
//Get Active session object
                                ...
                                SmSessionActivity sessionActivityToUpdateInterfaceComponent = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, updateInterfaceComponentSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.INTERFACECOMPONENTUPDATE, activeSession, activeUser);
