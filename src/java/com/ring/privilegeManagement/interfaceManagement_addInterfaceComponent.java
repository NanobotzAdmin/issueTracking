...
public class interfaceManagement_addInterfaceComponent extends HttpServlet {
 ...
 //                 check interface component name already exist 
                        PmInterfaceComponent checkComponent = new com.ring.privilegeManagementModel.PMS_PM_Interface_Component().searchComponentIdExit(ses, componentId);
...
//                      Save interdace component
                        PmInterfaceComponent subInterface = new com.ring.privilegeManagementModel.PMS_PM_Interface_Component().saveInterfaceComponent(ses, componentName, componentId, updatedDate, updatedDate, STATIC_DATA_MODEL.PMACTIVE, newInterface, activeUser, activeUser);
...
//                      Get Active session object
                              //Get Active session object
                                ...
                                SmSessionActivity sessionActivityToAddInterfaceComponent = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveInterfaceComponentSessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.INTERFACESAVE, activeSession, activeUser);
