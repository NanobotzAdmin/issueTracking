...
//                            check email exist
                                ...
                                if (valied2) {
//                            update new customer
                                    UmCustomer updateCustomer = new com.ring.customerManagementModel.CMS_UM_Customer().updateCustomer(ses, fullName, address, STATIC_DATA_MODEL.PMACTIVE, mobile, isverify, otpCode, nic, email, updatedDate, selectedBranch, selectedCustomer, activeUser.getId(), activeUser.getId());
                                    if (updateCustomer != null) {
                                        ...
                                        SmSessionActivity sessionActivityToUpdateCustomer = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, updateCustomerSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.CUSTOMERMANAGEMENT, updateCustomer.getId(), activeSession, activeUser);
