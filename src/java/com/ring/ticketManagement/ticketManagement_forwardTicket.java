...
//                        select sub location
                        ...
                        List<TmTicketsHasUmUser> checkUsersList = new com.ring.ticketManagementModel.TMS_TM_Tickets_Has_Um_User().getAllUsersByTicketId(ses, selectedTicket.getId());
                        ...
                        if (selectedQueue != null) {
                            ...
                            SmSessionActivity sessionActivityToForwardTicket = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, forwardTicketSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.TICKETMANAGEMENT, selectedTicket.getId(), activeSession, activeUser);
...
//                        save ticket forward reply 
                        TmTicketReply saveForwardReply = new com.ring.ticketManagementModel.TMS_TM_Ticket_Reply().saveTicketReply(ses, "Ticket has been <span class=\"badge bg-gradient-indigo\"> Forwared </span>", STATIC_DATA_MODEL.PMACTIVE, 0.0, updatedDate, updatedDate, selectedTicket, activeUser.getId(), activeUser.getId());      
                            tr.commit();
