 ...
 * @author JOY
 */
@WebServlet(name = "ticketManagement_addUsersToTicket", urlPatterns = {"/ticketManagement_addUsersToTicket"})
public class ticketManagement_addUsersToTicket extends HttpServlet {
...
//                    byte status = STATIC_DATA_MODEL.TICKETPENDING;
                    if (ticketId == 0) {
...
//                            System.out.println("selectedTicket = " + selectedTicket.getId());
...
//                                                    add user to Ticket
                                        ...
                                        TmTicketsHasUmUser addUsersToTicket = new com.ring.ticketManagementModel.TMS_TM_Tickets_Has_Um_User().addTicketHasUsers(ses, selectedTicket.getId(), selecUser.getId(), STATIC_DATA_MODEL.PMACTIVE, addedDate, addedDate, activeUser.getId(), activeUser.getId());
...
//                                add ticket created user to ticket has user table default
                                TmTicketsHasUmUser addUsersToTicket = new com.ring.ticketManagementModel.TMS_TM_Tickets_Has_Um_User().addTicketHasUsers(ses, selectedTicket.getId(), activeUser.getId(), STATIC_DATA_MODEL.PMACTIVE, addedDate, addedDate, activeUser.getId(), activeUser.getId());
                                UmUser ticketCreatedUser = (UmUser) ses.load(UmUser.class, selectedTicket.getCreatedBy());
                                String saveTicketHasUserSessionActivityContent = ticketCreatedUser.getFirstName() + " User has been Added To " + selectedTicket.getId() + " Ticket by " + activeUser.getFirstName() + " on " + addedDate;
                                SmSessionActivity sessionActivityToAddUserToTicket = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, saveTicketHasUserSessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.TICKETMANAGEMENT, selectedTicket.getId(), activeSession, activeUser);
