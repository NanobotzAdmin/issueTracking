...
//                                check updated question name exists
                                RcasQuestion checkNameExists = new com.ring.rootCauseManagementModel.RCMS_Rcas_Question().checkNameExists(ses, rcasQuestionU);
...
//                            update question details
                                    RcasQuestion updateQuestion = new com.ring.rootCauseManagementModel.RCMS_Rcas_Question().updateRootCauseQuestionQueue(ses, rcasQuestionU, STATIC_DATA_MODEL.PMACTIVE, updatedDate, selectedRCQ, activeUser.getId());
                                    if (updateQuestion != null) {
                                        ...
                                        SmSessionActivity sessionActivityToUpdateQuestion = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, updateQuestionSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.ROOTCAUSEQUESTION,updateQuestion.getId(),activeSession, activeUser);
                                        if (sessionActivityToUpdateQuestion != null) {
                                           int deleteRCQHasQues = new com.ring.rootCauseManagementModel.RCMS_QM_Queue_Has_Question().deleteRCQHasQueueByRCQId(ses, selectedRCQ.getId());
...
//                                                    add question has queues
                                                            QmQueueHasQuestion addQueuesToQuestion = new com.ring.rootCauseManagementModel.RCMS_QM_Queue_Has_Question().addRCQHasQueue(ses, selecQueue.getId(), selectedRCQ.getId(), STATIC_DATA_MODEL.PMACTIVE, updatedDate, updatedDate, activeUser.getId(), activeUser.getId());
