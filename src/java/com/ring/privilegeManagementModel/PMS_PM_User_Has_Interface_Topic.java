...
//    method for delete user has interface topic details by topic id
     ...
     public synchronized UmUserHasInterfaceTopic removeInterfaceTopicHasUser(Session ses, int userId, int interfaceTopic) {
        try {
            ...
            UmUserHasInterfaceTopicId addCompositeKey = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Topic_Id().addUserHasInterfaceComponentToComposite(ses, userId, interfaceTopic);
            ...
            if (addCompositeKey != null) {
                ...
                UmUserHasInterfaceTopic removeUserHasInterfaceTopic = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Topic().getAllInterfacetopicAndUser(ses, usr.getId(), topic.getId()); 
...
//    method for add interface top to user
    public synchronized UmUserHasInterfaceTopic saveInterfacetopicHasUser(Session ses, int user, int interfaceTopic,byte status, int position, Date createdDate, Date UpdatedDate, UmUser createdBy, UmUser updatedBy) {
        ...
        try {
            UmUserHasInterfaceTopicId addCompositeKey = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Topic_Id().addUserHasInterfaceComponentToComposite(ses, user, interfaceTopic);
