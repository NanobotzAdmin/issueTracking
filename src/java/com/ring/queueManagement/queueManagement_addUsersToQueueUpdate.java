...
//                      add user to Ticket
                            QmQueueHasUser addUsersToQueue = new com.ring.queueManagementModel.QMS_QM_Queue_Has_User().addQueueHasUsers(ses, selectedQueue.getId(), selectedUser.getId(), STATIC_DATA_MODEL.PMACTIVE, updatedDate, updatedDate, activeUser.getId(), activeUser.getId());
                            ...
                            SmSessionActivity sessionActivityToAddUserToQueue = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, saveQueuetHasUserSessionActivityContent, new Date(), STATIC_DATA_MODEL.INSERT, STATIC_DATA_MODEL.QUEUEMANAGEMENT, selectedQueue.getId(), activeSession, activeUser);
                            tr.commit();
