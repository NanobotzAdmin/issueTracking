...
//                            save queue has user details
                        ...
                        if (r > 0) {
                            for (int i = 0; i < r; ++i) {
                                ...
                                if (selecUser != null) {
//                                                    add user to Queue
                                    QmQueueHasUser addUsersToQueue = new com.ring.queueManagementModel.QMS_QM_Queue_Has_User().addQueueHasUsers(ses, selectedQueue.getId(), selecUser.getId(), STATIC_DATA_MODEL.PMACTIVE, addedDate, addedDate, activeUser.getId(), activeUser.getId());
                                }
                            }
                        }
                        tr.commit();
