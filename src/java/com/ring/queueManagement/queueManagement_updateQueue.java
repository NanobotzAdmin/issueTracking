...
//                                check updated queue name exists
                                QmQueue checkNameExists = new com.ring.queueManagementModel.QMS_QM_Queue().checkNameExists(ses, queueNameU);
...
//                            update Queue details
                                    QmQueue updateQueue = new com.ring.queueManagementModel.QMS_QM_Queue().updateQueue(ses, queueNameU, queueDescriptionU,STATIC_DATA_MODEL.PMACTIVE, addedDate, selectedQueue, activeUser.getId());
                                    if (updateQueue != null) {
                                        ...
                                        SmSessionActivity sessionActivityToUpdateQueue = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveQueueSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.QUEUEUPDATE, activeSession, activeUser);
