...
//                                check updated Category name exists
                                QmCategories checkNameExists = new com.ring.queueManagementModel.QMS_QM_Categories().checkNameExists(ses, categoryNameU);
...
//                            update Category details
                                    QmCategories updateCategory = new com.ring.queueManagementModel.QMS_QM_Categories().updateCategory(ses, categoryNameU, categoryDescriptionU, STATIC_DATA_MODEL.PMACTIVE, updatedDate, selectedCategory, selectedQueue,activeUser.getId());
                                    if (updateCategory != null) {
                                        ...
                                        SmSessionActivity sessionActivityToUpdateCategory = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveCategorySessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.CATEGORYUPDATE, activeSession, activeUser);
                                        if (sessionActivityToUpdateCategory != null) {
                                           int deleteCategoryHasUsers = new com.ring.queueManagementModel.QMS_QM_Categories_Has_User().deleteCategoryHasUsersByCategoryId(ses, selectedCategory.getId());
...
//                                                    add user to Category
                                                            QmCategoriesHasUser addUsersToCategory = new com.ring.queueManagementModel.QMS_QM_Categories_Has_User().addCategoryHasUsers(ses, selectedCategory.getId(), selecUser.getId(), STATIC_DATA_MODEL.PMACTIVE, addedDate, updatedDate, activeUser.getId(), activeUser.getId());
