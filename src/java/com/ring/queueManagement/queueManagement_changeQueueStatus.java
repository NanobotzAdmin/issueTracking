...
//                                    deactivate queue
                                ...
                                SmSessionActivity sessionActivityTochangeQueue = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivityNew(ses, changeQueueStatusSessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.QUEUEMANAGEMENT, selectedQueue.getId(), activeSession, activeUser);
