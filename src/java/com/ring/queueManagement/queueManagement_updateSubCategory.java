...
//                                check updated Sub Category name exists
                                QmSubCategories checkNameExists = new com.ring.queueManagementModel.QMS_QM_Sub_Categories().checkNameExists(ses, subCategoryNameU);
...
//                            update Sub Category details
                                    QmSubCategories updateSubCategory = new com.ring.queueManagementModel.QMS_QM_Sub_Categories().updateSubCategory(ses, subCategoryNameU, subCategoryDescriptionU, STATIC_DATA_MODEL.PMACTIVE, updatedDate, selectedSubCategory, selectedCategory,activeUser.getId());
                                    if (updateSubCategory != null) {
                                        ...
                                        SmSessionActivity sessionActivityToUpdateSubCategory = new com.ring.userManagementModel.UMS_UM_Session_Activity().saveSessionActivity(ses, saveSubCategorySessionActivityContent, new Date(), STATIC_DATA_MODEL.UPDATE, STATIC_DATA_MODEL.SUBCATEGORYUPDATE, activeSession, activeUser);
                                        if (sessionActivityToUpdateSubCategory != null) {
                                           int deleteSubCategoryHasUsers = new com.ring.queueManagementModel.QMS_QM_Sub_Categories_Has_User().deleteSubCategoryHasUsersBySubCategoryId(ses, selectedSubCategory.getId());
...
//                                                    add user to Sub Category
                                                            QmSubCategoriesHasUser addUsersToSubCategory = new com.ring.queueManagementModel.QMS_QM_Sub_Categories_Has_User().addSubCategoryHasUsers(ses, selectedSubCategory.getId(), selecUser.getId(), STATIC_DATA_MODEL.PMACTIVE, addedDate, updatedDate, activeUser.getId(), activeUser.getId());
