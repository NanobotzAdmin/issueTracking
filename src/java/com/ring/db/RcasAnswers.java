...
public class RcasAnswers  implements java.io.Serializable {
    ...
    public RcasAnswers(String answer, Date createdAt, Date updatedAt, Byte status, String remark1, String remark2, int createdBy, int updatedBy, Set tmTicketHasQueueHasQuestionHasAnswerses) {
       this.answer = answer;
