...
<%@page import="com.ring.userManagementModel.UMS_UM_Session_Activity"%>
...
<%
    ...
    TmTickets selectedTicket = new com.ring.ticketManagementModel.TMS_TM_Tickets().getTicketByKey(ses, ticketNumber);
