...
//            get interface component by interface id
                            List<PmInterfaceComponent> compoByInterface = new com.ring.privilegeManagementModel.PMS_PM_Interface_Component().getAllInterfaceComponentsByInterface(ses, selectedInterface.getId());
...
//                    get user has interface component by user role and interface component
                                    List<UmUserHasInterfaceComponent> getUserRoleUsersHasInterfaceComponent = new com.ring.privilegeManagementModel.PMS_PM_User_Has_Interface_Component().getAllUserHasInterfaceComponentByUserRoleAndComponentId(ses, selectedUserRole.getId(), userRoleHasCompo.getId());
